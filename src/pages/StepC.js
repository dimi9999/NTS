...
You confirm that you wish your application to be submitted to the NTS Panel and your NTS Manager lets you know the proposed date of the NTS Panel.  
`;
                ...
                <div className='formContainer status'>
                    ...
                    <div className='ProgressBarContainer'> 
                        <ul class="steps">
                            ...
                            <li class="remaining">
                                <span>
                                <strong><Link to="/StepD">Awaiting Desicion</Link></strong>
                                </span><i></i>
                            </li>
                            <li class="remaining">
                                <span>
                    ...
                    <div className="ApplicationStatusContainer">
                        ...
                        <div className='ApplicationStatus'> 
                            ...
                            <h1 className="ApplicationStatusValue">Your application status is: <strong class="Confirmed"> {statusValue} </strong></h1>
