                ...
                <form method="post">
                  ...
                  <div className='buttonsContainer'>
                      ...
                      <div className='row'>
                        ...
                        <input type='password' required placeholder='Please enter your PIN' />           
                      </div>

                      {/* Error appears here if you input a wrong PIN */}
                      <div className='row'>
                        <span className='btn btn-error block'>You have entered an Invalid PIN or Email.</span>           
                      </div>

                      {/* Login */}
                      <div className='row'>
                        <Link className='btn btn-primary block' to='/step'>Login to your status</Link>           
                      </div>
