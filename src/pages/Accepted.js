...
The NTS Panel is delighted to inform you that your NTS application, has now been accepted and can proceed onto next stage. 
`
                ...
                <div className='formContainer status'>
                    ...
                    <div className='ProgressBarContainer'> 
                        <ul class="steps">
                            ...
                            <li class="remaining">
                                <span>
                                <strong><Link to="/StepE">In Valuation</Link></strong>
                                </span><i></i>
                            </li>
                            <li class="remaining">
                                <span>
                    ...
                    <div className="ApplicationStatusContainer">
                        ...
                        <div className='ApplicationStatus'> 
                            ...
                            <h1 className="ApplicationStatusValue">Your application status is: <strong class="Accepted"> {statusValue} </strong></h1>
