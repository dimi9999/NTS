...
// 5. Import Global Auth State
import AuthContext from '../context/authProvider';

// 6. Import Axios to Call External and Azure Sharepoint Data
import axios from '../api/axios';
const LOGIN_URL = 'http://localhost:3001/context/authProvider';
...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      const axiosInstance = axios.create({
        baseURL: 'https://localhost:3000',  // Adjust this to your API domain or your Azure SharePoint Apps
      });
